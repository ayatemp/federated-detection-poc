...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "17_client_balanced_early_injection_dqamox.ipynb"
...
cells = [
    md(
        """
        # 17 Client-Balanced Early-Injection Full-From-Warmup DQA-MoX
    ...
    code(
        ...
        RUNNER = PROJECT_ROOT / "scripts" / "run_scene_daynight_dqa_17_client_balanced_early_injection_dqamox.py"
        WORKSPACE = PROJECT_ROOT / "output" / "17_client_balanced_early_injection_dqamox"
    ...
    code(
        """
        spec = importlib.util.spec_from_file_location("dqa17_runner", RUNNER)
    ...
    md(
        ...
        - `output/17_client_balanced_early_injection_dqamox/stats/17_client_balanced_early_injection_dqamox_final_metrics.csv`
        - `output/17_client_balanced_early_injection_dqamox/stats/17_client_balanced_early_injection_dqamox_split_metrics.csv`
        - `output/17_client_balanced_early_injection_dqamox/17_client_balanced_early_injection_dqamox_report.md`
    ...
    code(
        ...
        cmd = [
            ...
            "--dqa-client-balance-max-scale", "3.0",
    ...
    code(
        """
        metrics_path = WORKSPACE / "stats" / "17_client_balanced_early_injection_dqamox_final_metrics.csv"
        split_path = WORKSPACE / "stats" / "17_client_balanced_early_injection_dqamox_split_metrics.csv"
        report_path = WORKSPACE / "17_client_balanced_early_injection_dqamox_report.md"
