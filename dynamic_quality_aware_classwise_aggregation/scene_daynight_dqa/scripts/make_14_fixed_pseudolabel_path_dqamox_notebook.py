...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "14_fixed_pseudolabel_path_dqamox.ipynb"
...
cells = [
    md(
        """
        # 14 Fixed-PseudoLabel-Path Full-From-Warmup DQA-MoX
    ...
    code(
        ...
        RUNNER = PROJECT_ROOT / "scripts" / "run_scene_daynight_dqa_14_fixed_pseudolabel_path_dqamox.py"
        WORKSPACE = PROJECT_ROOT / "output" / "14_fixed_pseudolabel_path_dqamox"
    ...
    code(
        """
        spec = importlib.util.spec_from_file_location("dqa14_runner", RUNNER)
    ...
    md(
        ...
        - `output/14_fixed_pseudolabel_path_dqamox/stats/14_fixed_pseudolabel_path_dqamox_final_metrics.csv`
        - `output/14_fixed_pseudolabel_path_dqamox/stats/14_fixed_pseudolabel_path_dqamox_split_metrics.csv`
        - `output/14_fixed_pseudolabel_path_dqamox/14_fixed_pseudolabel_path_dqamox_report.md`
    ...
    code(
        """
        metrics_path = WORKSPACE / "stats" / "14_fixed_pseudolabel_path_dqamox_final_metrics.csv"
        split_path = WORKSPACE / "stats" / "14_fixed_pseudolabel_path_dqamox_split_metrics.csv"
        report_path = WORKSPACE / "14_fixed_pseudolabel_path_dqamox_report.md"
