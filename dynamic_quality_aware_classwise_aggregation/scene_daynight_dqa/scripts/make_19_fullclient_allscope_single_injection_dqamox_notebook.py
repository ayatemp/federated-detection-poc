...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "19_fullclient_allscope_single_injection_dqamox.ipynb"
...
cells = [
    md(
        """
        # 19 Full-Client All-Scope Single-Injection DQA-MoX
    ...
    code(
        ...
        RUNNER = PROJECT_ROOT / "scripts" / "run_scene_daynight_dqa_19_fullclient_allscope_single_injection_dqamox.py"
        WORKSPACE = PROJECT_ROOT / "output" / "19_fullclient_allscope_single_injection_dqamox"
    ...
    md(
        ...
        - `output/19_fullclient_allscope_single_injection_dqamox/stats/19_fullclient_allscope_single_injection_dqamox_final_metrics.csv`
        - `output/19_fullclient_allscope_single_injection_dqamox/stats/19_fullclient_allscope_single_injection_dqamox_split_metrics.csv`
        - `output/19_fullclient_allscope_single_injection_dqamox/19_fullclient_allscope_single_injection_dqamox_report.md`
    ...
    code(
        ...
        EXPERT_KEEP_FRACTION = 0.60
        EXPERT_MAX_CLASS_FRACTION = 0.20
        ACTUAL_MAX_CLASS_FRACTION = 0.22
        LOAD_BIAS_STRENGTH = 0.55
        ...
        cmd = [
            ...
            "--server-repair-loss-box", "0.03",
            "--router-temperature", "1.45",
            "--router-balance-weight", "0.05",
            "--router-entropy-weight", "0.004",
    ...
    code(
        """
        metrics_path = WORKSPACE / "stats" / "19_fullclient_allscope_single_injection_dqamox_final_metrics.csv"
        split_path = WORKSPACE / "stats" / "19_fullclient_allscope_single_injection_dqamox_split_metrics.csv"
        report_path = WORKSPACE / "19_fullclient_allscope_single_injection_dqamox_report.md"
