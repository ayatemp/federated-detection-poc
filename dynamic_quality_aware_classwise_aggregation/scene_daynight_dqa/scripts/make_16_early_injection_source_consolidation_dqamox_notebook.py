...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "16_early_injection_source_consolidation_dqamox.ipynb"
...
cells = [
    md(
        """
        # 16 Early-Injection Source-Consolidation Full-From-Warmup DQA-MoX
    ...
    code(
        ...
        RUNNER = PROJECT_ROOT / "scripts" / "run_scene_daynight_dqa_16_early_injection_source_consolidation_dqamox.py"
        WORKSPACE = PROJECT_ROOT / "output" / "16_early_injection_source_consolidation_dqamox"
    ...
    code(
        """
        spec = importlib.util.spec_from_file_location("dqa16_runner", RUNNER)
    ...
    md(
        ...
        - `output/16_early_injection_source_consolidation_dqamox/stats/16_early_injection_source_consolidation_dqamox_final_metrics.csv`
        - `output/16_early_injection_source_consolidation_dqamox/stats/16_early_injection_source_consolidation_dqamox_split_metrics.csv`
        - `output/16_early_injection_source_consolidation_dqamox/16_early_injection_source_consolidation_dqamox_report.md`
    ...
    code(
        """
        metrics_path = WORKSPACE / "stats" / "16_early_injection_source_consolidation_dqamox_final_metrics.csv"
        split_path = WORKSPACE / "stats" / "16_early_injection_source_consolidation_dqamox_split_metrics.csv"
        report_path = WORKSPACE / "16_early_injection_source_consolidation_dqamox_report.md"
