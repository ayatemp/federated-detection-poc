#!/usr/bin/env python3
"""Create notebook 30: self-only split-routed high-res/SAHI policy MoE."""
...
NOTEBOOK = PROJECT_ROOT / "notebooks" / "30_split_policy_highres_sahi_moe.ipynb"
    ...
    notebook = {
        "cells": [
            markdown_cell(
                ...
                "29でclient expert加算が悪化したので、自己生成のみの強いrouted MoEへ戻り、"
                "scene/day-nightをrouterとして解像度とSAHIを切り替える。外部COCO expertは使わない。"
            ),
