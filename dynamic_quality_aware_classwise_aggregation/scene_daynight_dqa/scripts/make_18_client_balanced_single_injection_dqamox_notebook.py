...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "18_client_balanced_single_injection_dqamox.ipynb"
...
cells = [
    md(
        """
        # 18 Client-Balanced Single-Injection Full-From-Warmup DQA-MoX
    ...
    code(
        ...
        WORKSPACE = PROJECT_ROOT / "output" / "18_client_balanced_single_injection_dqamox"
    ...
    md(
        ...
        - `output/18_client_balanced_single_injection_dqamox/stats/18_client_balanced_single_injection_dqamox_final_metrics.csv`
        - `output/18_client_balanced_single_injection_dqamox/stats/18_client_balanced_single_injection_dqamox_split_metrics.csv`
        - `output/18_client_balanced_single_injection_dqamox/18_client_balanced_single_injection_dqamox_report.md`
