#!/usr/bin/env python3
"""Run DQA-CWA v2 with the same FedSTO/EfficientTeacher schedule as 03."""
...
DQA_PROTOCOL_VERSION = "dqa_ver2_server_residual_anchor_v1"
...
base.DEFAULT_DQA_WORK_ROOT = base.RESEARCH_ROOT / "efficientteacher_dqa_ver2"
