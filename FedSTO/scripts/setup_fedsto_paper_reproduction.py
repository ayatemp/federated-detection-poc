...
WORK_ROOT = PROJECT_ROOT / "outputs" / "efficientteacher_fedsto"
LIST_ROOT = WORK_ROOT / "data_lists"
CONFIG_ROOT = WORK_ROOT / "configs"
RUN_ROOT = WORK_ROOT / "runs"
ET_ROOT = PROJECT_ROOT / "external" / "efficientteacher"
SSFOD_ROOT = PROJECT_ROOT / "external" / "ssfod_official"
    ...
    *,
    ...
    if target is not None:
        ...
        cfg["SSOD"] = {
            ...
            "ema_rate": 0.999,
            # FedSTO Appendix H.2 states a fixed EMA decay alpha=0.999.
            # EfficientTeacher's cosine EMA is useful for its own recipe, but
            # it is not specified by FedSTO, so keep the paper default fixed.
            "cosine_ema": False,
