...
_C.FedSTO = CN()
_C.FedSTO.orthogonal_weight = 0.0
_C.FedSTO.orthogonal_scope = 'non_backbone'
_C.FedSTO.train_scope = 'all'
_C.FedSTO.unlabeled_only_client = False

_C.ClassSkewFedSTO = CN()
_C.ClassSkewFedSTO.enabled = False
_C.ClassSkewFedSTO.use_residual = False
_C.ClassSkewFedSTO.orthogonal_weight = 0.0
...
_C.LatentMoE.sample_entropy_weight = 0.0
_C.LatentMoE.specialization_weight = 0.0
_C.LatentMoE.specialization_target = -1
_C.LatentMoE.routing_mode = "soft"
_C.LatentMoE.straight_through = False
_C.LatentMoE.expert_choice_capacity_factor = 1.0
_C.LatentMoE.router_init_std = 0.0

_C.BackboneMoE = CN()
_C.BackboneMoE.enabled = False
_C.BackboneMoE.num_experts = 8
_C.BackboneMoE.top_k = 2
_C.BackboneMoE.temperature = 1.0
_C.BackboneMoE.scale = 0.25
_C.BackboneMoE.shared_scale = 1.0
_C.BackboneMoE.adapter_ratio = 0.125
_C.BackboneMoE.min_channels = 16
_C.BackboneMoE.levels = ['c3', 'c4', 'c5']
_C.BackboneMoE.kernels = [3, 5, 7]
_C.BackboneMoE.context_dim = 0
_C.BackboneMoE.context = []
_C.BackboneMoE.quality_dim = 4
_C.BackboneMoE.router_noise_std = 0.0
_C.BackboneMoE.balance_weight = 0.0
_C.BackboneMoE.entropy_weight = 0.0
_C.BackboneMoE.sample_entropy_weight = 0.0
_C.BackboneMoE.z_loss_weight = 0.0
_C.BackboneMoE.diversity_weight = 0.0
_C.BackboneMoE.threshold_routing = False
_C.BackboneMoE.threshold = 0.0
_C.BackboneMoE.freeze_bn = False
_C.BackboneMoE.routing_mode = "soft"
_C.BackboneMoE.straight_through = False
_C.BackboneMoE.expert_choice_capacity_factor = 1.0
_C.BackboneMoE.dqa_prior_strength = 0.0
_C.BackboneMoE.router_init_std = 0.0

_C.NeckMoE = CN()
_C.NeckMoE.enabled = False
_C.NeckMoE.num_experts = 8
_C.NeckMoE.top_k = 2
_C.NeckMoE.temperature = 1.0
_C.NeckMoE.scale = 0.15
_C.NeckMoE.shared_scale = 1.0
_C.NeckMoE.adapter_ratio = 0.0625
_C.NeckMoE.min_channels = 16
_C.NeckMoE.levels = ['p3', 'p4', 'p5']
_C.NeckMoE.kernels = [3, 5]
_C.NeckMoE.context_dim = 0
_C.NeckMoE.context = []
_C.NeckMoE.quality_dim = 4
_C.NeckMoE.router_noise_std = 0.0
_C.NeckMoE.balance_weight = 0.0
_C.NeckMoE.entropy_weight = 0.0
_C.NeckMoE.sample_entropy_weight = 0.0
_C.NeckMoE.z_loss_weight = 0.0
_C.NeckMoE.diversity_weight = 0.0
_C.NeckMoE.threshold_routing = False
_C.NeckMoE.threshold = 0.0
_C.NeckMoE.freeze_bn = False
_C.NeckMoE.routing_mode = "soft"
_C.NeckMoE.straight_through = False
_C.NeckMoE.expert_choice_capacity_factor = 1.0
_C.NeckMoE.dqa_prior_strength = 0.0
_C.NeckMoE.router_init_std = 0.0
